...
<?php echo renderNav_local (); ?>

	<div class="container-fluid mt-3 mb-3" style="margin-top: 90px !important">
		<div class="row">
			<div class="col-md-6">
				...
				<button type="button" class="btn btn-outline-info" id="upload">Завантажити файл 'aggregators.xls'</button>
			</div>
			<div class="col-md-6">
