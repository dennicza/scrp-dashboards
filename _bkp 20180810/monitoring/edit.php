...
?>
    ...
    <nav class="navbar fixed-bottom navbar-light bg-light">
        <button type="button" class="btn btn-outline-primary" data-monitoring="<?php echo $_GET['monit_id']; ?>" id="upd2db" data-query="<?php echo substr($qr, 1); ?>">Зберегти зміни</button>
